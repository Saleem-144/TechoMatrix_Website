    ...
    <body class="t-bg-light-2">
        ...
        <!-- Main Section -->
            ...
            <!-- Button trigger modal -->
                ...
                <button type="button" class="t-link bttn bttn-md bttn-round bttn-primary border-0" style="margin: 50px; width: 250px; height: 250px; border-radius: 50%;" data-toggle="modal" data-target="#exampleModal">
                Let's Talk
                </button>
                </div>
            <!-- Modal -->
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content" >
                    ...
                    <h5 class="modal-title" id="exampleModalLabel" style="color: black;">Hey !! </h5>
